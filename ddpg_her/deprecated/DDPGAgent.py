import numpy as np
import torch
from ddpg_her.deprecated.ActorCritic import Actor, Critic
...
class DDPGAgent:
    def __init__(self, actor_learning_rate, critic_learning_rate, n_actions,
                 ...
                 epsilon=0.9, dec_epsilon=1e-7, min_epsilon=0.1, checkpoint_dir='/tmp/ddqn/'):
    ...
    def choose_action(self, observation, goal):
        ...
        if np.random.random() > 0.1:
            ...
            selected_action = np.random.rand(self.n_actions)
